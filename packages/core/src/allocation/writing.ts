...
- "email.hook" : UNE phrase, deux au plus. Elle commence par « En regardant votre site » (ou « En ouvrant votre site », « En cherchant votre site ») et dit le problème principal, poliment, comme un client le verrait : « il s'affiche difficilement sur téléphone », « il date de 2014 et ne l'a pas quitté », « un message « Non sécurisé » apparaît à côté de l'adresse », « il ne s'ouvre plus ». Un seul problème, le plus visible ; un second seulement s'il tient dans la même phrase. Pas de mise en scène (« je cherchais une bijouterie… »), pas de leçon sur ce que ça coûte, pas de conseil.
- "email.proposal" : UNE phrase qui dit ce que le freelance ferait, concrètement, adapté au métier de l'entreprise : « Je vous propose de le remettre à niveau : lisible sur téléphone, sécurisé, avec vos horaires et votre carte bien en vue. » Pas de « je peux vous envoyer quelques lignes », pas de « vous regardez et vous décidez », pas de question : la demande est ajoutée à part.
